...
<CodeSurfer
  ...
  steps={[
      ...
      { range: [2,5], notes: "Define the melody" },
...
<CodeSurfer
  ...
  steps={[
      ...
      { range: [9,9], notes: "This is the more 'mathematical' approach to composition" },
...
```notes
Writing a function to convert a shorthand string notation into an array of objects that can be turned into audio by the Web Audio API
```
---
...
<CodeSurfer
  ...
  steps={[
      ...
      { range: [34,34], notes: "Each remaining element will be mapped to its length"},
