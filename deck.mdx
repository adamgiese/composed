...
<CodeSurfer
  ...
  steps={[
      ...
      { range: [22,22], notes: "The return value is the end 'accumulation'" },
  ]}
/>
...
# TODO: shorthand "goal" example (convert shorthand to json)

---

<CodeSurfer
  code={require("!raw-loader!./components/music/wow/index.js")}
  lang="javascript"
  showNumbers={false}
  dark={true}
  steps={[
      { range: [1,16], notes: "First, import utility functions"},
      { range: [1,16], notes: "First, import utility functions"},
  ]}
/>
