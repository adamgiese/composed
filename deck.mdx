...
<CodeSurfer
  ...
  steps={[
      {},
      { range: [4,4], notes: "`isInCPentatonic` is a 'predicate' (a function that returns a boolean)" },
      { range: [5,5], notes: "The `.filter` method accepts `isInCPentatonic` as an argument"},
      { range: [6,6], notes: "Any value that returns a truthy value remains"},
  ]}
/>
---
...
<CodeSurfer
  ...
  steps={[
      {},
      { range: [6,10], notes: "This function takes an array of notes and returns a new array of only unique notes" },
      { range: [7,8], notes: "Parses a note down to just the name (regardless of octave)" },
      { range: [9,9], notes: "Append note if it isn't already in the unique array" },
      { range: [12,15], notes: "The .reduce method accepts two parameters" },
      { range: [13,13], notes: "An accumulator function..." },
      { range: [14,14], notes: "...and an initial value of the accumulation." },
      { range: [16,16], notes: "The return value is the end 'accumulation'" },
  ]}
/>
